package csv.question6;
import java.io.*;
import java.util.*;

public class UpdateSalary {
    public static void main(String[] args) throws IOException {
        String inputFile = "C:\\Users\\hp\\Desktop\\BridgeLabz-Training\\java-iostreams-practice\\gcr-codebase\\JavaIOStreamsConcepts\\src\\csv\\question6\\employees.csv";
